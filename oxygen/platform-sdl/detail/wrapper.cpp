...
auto CheckMutuallyExclusiveFlags(
    std::convertible_to<bool> auto... flags) -> bool {
  return ((0 + ... + flags) <= 1);
}

void TranslateFlagsToProperties(SDL_PropertiesID props,
...
auto oxygen::platform::sdl::detail::Wrapper::MakeWindow(const char *title,
