...
public:
  ...
  auto OnCloseRequested() -> auto & {
    return on_close_requested_;
  }
  ...
  auto OnMinimized() -> auto & {
    return on_minimized_;
  }

  auto OnMaximized() -> auto & {
    return on_maximized_;
  }

  auto OnRestored() -> auto & {
    return on_restored_;
  }
