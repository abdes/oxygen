...
#define OXYGEN_CLANG_VERSION_CHECK(major, minor, patch)                          \
  (OXYGEN_CLANG_VERSION >= OXYGEN_VERSION_ENCODE_INTERNAL_(major, minor, patch))
#else
...
#define OXYGEN_GNUC_VERSION                                                      \
  OXYGEN_VERSION_ENCODE_INTERNAL_(__GNUC__, __GNUC_MINOR__, __GNUC_PATCHLEVEL__)
...
#define OXYGEN_GNUC_VERSION_CHECK(major, minor, patch)                           \
  (OXYGEN_GNUC_VERSION >= OXYGEN_VERSION_ENCODE_INTERNAL_(major, minor, patch))
#else
...
#endif
#if OXYGEN_HAS_BUILTIN(__builtin_unreachable) || OXYGEN_GCC_VERSION_CHECK(4, 5, 0)
